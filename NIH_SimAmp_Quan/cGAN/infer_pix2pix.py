...
dir = opt.dir
save_dir = os.path.join(dir, f'cgan_{opt.generator_type}_{opt.my_id}_infer')
...
if opt.pretrain_dir is not None:
    ...
    try:
        ...
        if master_process: print('LOADED WEIGHTS for G')
    ...
    if master_process: print('No model is loaded, EXIT')
    exit()
